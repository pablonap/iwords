...
import com.binary_winters.projects.iverbs.plus.PalabraBind;
...
public class PracticarMisPalabrasActivity extends AppCompatActivity {
    private Integer cantidadDePalabrasNumerica;

    static PalabraBind palabraBind;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toast = Toast.makeText(PracticarMisPalabrasActivity.this, "", Toast.LENGTH_LONG);
        ...
        buttonSoundParaPalabra.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                PalabraAgregadaBean palabraHallada =
                        palabraBind.buscarPalabraSegunNombrePalabraEnEsp(palabrasEnEspHelper.get(indice).getPalabraEnEsp());
                AudioRecord.startPlaying(palabraHallada.getNombreArchivoAudio());
        ...
        imageViewStarFromPalabras.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(palabraEnEspHelperActual != null){
                    ...
                    PalabraAgregadaBean palabraFromDB = realm.where(PalabraAgregadaBean.class).equalTo("id", palabraEnEspHelperActual.getId()).findFirst();
        ...
        buttonVerificarPalabra.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(row1_verb1_2 != null){
                    String respuesta = palabraBind.buscarCadenaDeUsuarioEnMapa(row1_verb1_2, palabrasEnEspHelper.get(indice), isSoloEscrituraOn);
                    ...
                    if(contadorParaFelicitacion == 7){
                        Toast.makeText(PracticarMisPalabrasActivity.this, getString(R.string.siete_correctas), Toast.LENGTH_SHORT).show();
                    } else if(contadorParaFelicitacion == 15){
                        Toast.makeText(PracticarMisPalabrasActivity.this, getString(R.string.quince_correctas), Toast.LENGTH_SHORT).show();
                    } else if(contadorParaFelicitacion == 20){
                        Toast.makeText(PracticarMisPalabrasActivity.this, getString(R.string.veinte_correctas), Toast.LENGTH_SHORT).show();
                    } else if(contadorParaFelicitacion == 35){
                        Toast.makeText(PracticarMisPalabrasActivity.this, getString(R.string.treinta_y_cinco_correctas), Toast.LENGTH_SHORT).show();
                    }
                    ...
                    if(indice >= cantidadDePalabrasNumerica){
                        contadorParaFelicitacion = 0;
                        if(palabraBind.getListaDePalabrasEnEspMalRespondidas().size() > 0){
                        ...
                        if(contadorParaToast == 3){
                            toast = Toast.makeText(PracticarMisPalabrasActivity.this, "", Toast.LENGTH_SHORT);
                            contadorParaToast = 0;
                        }
                    }
                }
                ...
                if(isModoContdownActivado && indice < cantidadDePalabrasNumerica && isPermitido){
                    if(indice == cantidadDePalabrasNumerica - 1){
                        buttonVerificarPalabra.setEnabled(false);
                    }
    ...
    public void mostrarDialogCantidadDePalabras() {
        ...
        textViewCantidadParte2.setText(palabraBind.getCantidadPalabras().toString());
        textViewCantidadFavoritosParte2.setText(palabraBind.getCantidadPalabrasFavoritas().toString());
                ...
                buttonPositive.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if("".equals(editTextCantidad.getText().toString())){
                            ...
                            int CANTIDAD_MAXIMA_PALABRAS = palabraBind.darSizeDeListaTotalDePalabrasEnEsp(radioButtonConTodos.isChecked());
                            if(CANTIDAD_MAXIMA_PALABRAS > 0){
                                if(cantidadDePalabrasNumerica > 0 && cantidadDePalabrasNumerica <= CANTIDAD_MAXIMA_PALABRAS){
                                    ...
                                    for(int i=0; i<cantidadDePalabrasNumerica; i++ ){
                                        palabrasEnEspHelper.add(palabraBind.generarPalabraRandom(radioButtonConTodos.isChecked()));
                                    }
    ...
    private void mostrarDialogRecomendacion() {
        ...
        imageViewShareScore.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(PracticarMisPalabrasActivity.this, getString(R.string.puntaje_msj), Toast.LENGTH_SHORT).show();
    ...
    private String mostrarResultadoFinal(){
        Integer porcentajeAciertos = (palabraBind.getCantidadDeRespuestasCorrectas() * 100) / cantidadDePalabrasNumerica;
        Integer porcentajeIncorrectas = (palabraBind.getListaDePalabrasEnEspMalRespondidas().size() * 100) / cantidadDePalabrasNumerica;

        String correctas = getString(R.string.correctas) + palabraBind.getCantidadDeRespuestasCorrectas() + " " + porcentajeAciertos +  "%";
        String incorrectas = getString(R.string.incorrectas) + palabraBind.getListaDePalabrasEnEspMalRespondidas().size() + " " + porcentajeIncorrectas +  "%";

        return correctas + "\n" + incorrectas;
    }

    public void practicarDesdePalabrasIncorrectas(){
        palabraBind.setCantidadDeRespuestasCorrectas(0);
        indice = 0;
        cantidadDePalabrasNumerica = palabraBind.getListaDePalabrasEnEspMalRespondidas().size();

        palabrasEnEspHelper.clear();

        this.aramarListaAleatoria(palabrasEnEspHelper, palabraBind.getListaDePalabrasEnEspMalRespondidas());
